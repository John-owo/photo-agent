...
relabelled as a PhotoAgent T09 end-to-end run. The branch is now published and
the hosted CI run above is green. No PR was created and Issue #14 remains open.
